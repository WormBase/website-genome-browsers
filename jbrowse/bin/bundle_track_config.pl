...
my @files = (
      "includes/c_elegans_PRJNA13758_DNA.json",
      ...
      "includes/sequence_similarity_isoseq_best.json",
      ...
      "includes/sequence_similarity_isoseq_other.json",
